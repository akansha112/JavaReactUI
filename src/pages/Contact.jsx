...
export default function Contact() {
  ...
  return (
    <div style={{ maxWidth: "1100px", margin: isMobile ? "80px auto 40px" : "120px auto 60px", padding: "0 20px" }}>
      <header style={{ textAlign: "center", marginBottom: "40px" }}>
        <h1 style={{ fontSize: isMobile ? "2.2rem" : "3rem", marginBottom: "10px" }}>
          Get In <span style={{ color: "#6B73FF" }}>Touch</span>
        </h1>
        <p style={{ color: "rgba(255,255,255,0.6)", fontSize: isMobile ? "0.9rem" : "1rem" }}>Let's build something amazing together.</p>
      </header>
