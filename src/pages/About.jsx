  ...
  return (
    <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "60px 20px" }}>
      ...
      <section style={{ textAlign: "center", marginBottom: "60px" }}>
        ...
        <p style={{ fontSize: "1.2rem", lineHeight: "1.6", color: "rgba(255,255,255,0.8)", maxWidth: "800px", margin: "0 auto" }}>
          ...
          it serves as an interactive bridge between my portfolio and your curiosity.
        </p>
      </section>
      ...
      <div style={{ 
        ...
        {features.map((f, i) => (
          ...
          >
            ...
            <h3 style={{ marginBottom: "12px", fontSize: "1.4rem" }}>{f.title}</h3>
            <p style={{ color: "rgba(255,255,255,0.7)", lineHeight: "1.5" }}>{f.desc}</p>
          </div>
        ))}
      </div>
      ...
      <div style={{ 
        ...
        <p>Head back to the Home page to start a conversation with the AI.</p>
      </div>
    </div>
  );
}