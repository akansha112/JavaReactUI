...
export default function About() {
  ...
  const glassStyle = {
    ...
    borderRadius: "24px",
    padding: isMobile ? "20px" : "30px", // Less padding on mobile
    transition: "transform 0.3s ease, background 0.3s ease",
  };

  return (
    <div style={{ maxWidth: "1100px", margin: "0 auto", padding: isMobile ? "100px 20px 40px" : "120px 20px 60px" }}>
      {/* App Introduction */}
      <section style={{ textAlign: "center", marginBottom: "60px" }}>
        <h1 style={{ fontSize: isMobile ? "2rem" : "3rem", marginBottom: "20px", fontWeight: "800" }}>
      ...
      <div style={{ 
        ...
        {features.map((f, i) => (
          ...
          >
            <div style={{ width: "40px", height: "40px", background: "linear-gradient(135deg, #6B73FF, #000DFF)", borderRadius: "10px", marginBottom: "20px" }}></div>
      ...
      <div style={{ 
        ...
        <p style={{ fontSize: isMobile ? "0.9rem" : "1rem" }}>Head back to the Home page to start a conversation with the AI.</p>
      </div>
    </div>
  );
}